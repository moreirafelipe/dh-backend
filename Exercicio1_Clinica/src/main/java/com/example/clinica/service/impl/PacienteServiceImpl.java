...
public class PacienteServiceImpl implements PacienteService {
    ...
    private Dentista dentistaRel = new Dentista(1, "Felipe", "Oliveira", "A01");
    ...
    private Paciente paciente2 = new Paciente(2, "Neide", "Blanco", "neideblanco@email.com", "98765432112", LocalDate.now(), endereco2, dentistaRel);
